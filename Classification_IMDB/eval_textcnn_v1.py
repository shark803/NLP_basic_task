...
tf.flags.DEFINE_string("checkpoint_dir", "./model/textCNN_v1/Checkpoints", "Checkpoint directory")
...
with open('testResults_cnn_v1.tsv','w',encoding='utf-8') as fout:
