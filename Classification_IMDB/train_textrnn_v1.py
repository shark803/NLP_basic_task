...
from model_textrnn_v1 import BiLSTMAttention
# 输出batch数据集
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # 保存模型的一种方式，保存为pb文件
        builder = tf.saved_model.builder.SavedModelBuilder("./model/textRNN_v1/PBModel")
        ...
        for i in range(config.training.epoches):
            ...
            for batchTrain in nextBatch(trainReviews, trainLabels, config.batchSize):
                ...
                if currentStep % config.training.checkpointEvery == 0:
                    ...
                    path = saver.save(sess, "./model/textRNN_v1/Checkpoints/checkpoint", global_step=currentStep)
