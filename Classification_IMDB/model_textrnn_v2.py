...
from config_textrnn_v1 import Config,TrainingConfig
...
def rnn_model_fn(features,labels,mode):
    ...
    with tf.name_scope("dropout"):
        hDrop = tf.nn.dropout(output, dropoutKeepProb)
...
imdb_classifier = tf.estimator.Estimator(model_fn=rnn_model_fn,model_dir="imdb_model_textrnnv2",config=run_config)
...
print('test set')
#print(results)
with open('./testResults_textrnn_v2.tsv','w',encoding='utf-8') as fout:
